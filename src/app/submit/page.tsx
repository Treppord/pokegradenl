...
export default function SubmitPage() {
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 3:
        return (
          shippingInfo.pickupAddress.firstName &&
  ...
  return (
    <Layout>
        ...
        <div className="container-custom">
          <div className="text-center">
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-300 max-w-2xl mx-auto">
              Follow our simple 4-step process to submit your Pokémon cards for
                      ...
                      {serviceTiers.map((tier) => (
                        <div
                          ...
                          className={`cursor-pointer border-2 rounded-lg p-6 transition-all ${
                            selectedTier === tier.id
                              ? "border-primary-500 bg-primary-50 dark:bg-neutral-800 dark:border-primary-500"
                        ...
                        >
                          ...
                          <p className="text-2xl font-bold text-primary-500 mb-2">
                            €{tier.price}
                            <span className="text-sm font-normal text-neutral-600 dark:text-neutral-300 ml-1">
                              per card
                            </span>
                          </p>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      {cards.map((card, index) => (
                        <div
                          key={card.id}
                          className="border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 rounded-lg p-6"
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <Select
                              ...
                              value={card.set}
                              onChange={(e) =>
                                updateCard(card.id, "set", e.target.value)
                              }
                            ...
                            <Select
                              ...
                              value={card.language}
                              onChange={(e) =>
                                updateCard(card.id, "language", e.target.value)
                              }
                            />
                          </div>
                        </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="bg-neutral-50 dark:bg-neutral-800 p-4 rounded-lg">
                          <p className="font-medium dark:text-white">
                            {
                              serviceTiers.find((t) => t.id === selectedTier)
                                ?.name
                            }
                          </p>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {cards.map((card, index) => (
                            <div
                              key={card.id}
                              className="bg-neutral-50 dark:bg-neutral-800 p-3 rounded-lg flex justify-between items-center"
                            >
                      ...
                      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        ...
                        <p className="text-yellow-700 text-sm mt-1">
                          This submission will be saved and you will receive
      ...
      {/* Security Section */}
      <section className="bg-neutral-50 dark:bg-dark-bg py-12">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-600 dark:text-neutral-300">
                Monitor your cards every step of the way
              </p>
            </div>
            <div className="text-center">
