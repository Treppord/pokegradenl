...
export const metadata: Metadata = {
  title: 'Grading Services - Professional Pokémon Card Grading',
  description: 'Comprehensive Pokémon card grading services in the Netherlands. Choose from Value, Standard, or Premium grading tiers with fast turnaround times and competitive pricing.',
  keywords: [
    'Pokemon card grading services',
    'Pokemon card authentication',
    'TCG grading Netherlands',
    'Pokemon grading prices',
    'card grading turnaround',
    'Pokemon card condition',
    'PSA alternative Netherlands',
    'professional card grading',
  ],
  openGraph: {
    title: 'Grading Services - Professional Pokémon Card Grading',
    description: 'Professional Pokémon card grading services with multiple pricing tiers and fast turnaround times.',
    url: '/services',
  },
};
