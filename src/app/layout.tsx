...
export const metadata: Metadata = {
  ...
  description: 'Professional Pokémon card grading service in the Netherlands. Precision grading, passionately delivered. Get your cards authenticated and graded by certified experts.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Professional Pokémon card grading service in the Netherlands. Precision grading, passionately delivered.',
