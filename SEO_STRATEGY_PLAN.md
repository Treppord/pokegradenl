...
```html
<!-- Before -->
<img src="/example-1.png" alt="Genesect Ex" />

<!-- After -->  
<img src="/example-1.png" alt="Genesect Ex Pokémon kaart professioneel gegraded door PokeGrade Nederland - Pokemon card grading example" />
```
